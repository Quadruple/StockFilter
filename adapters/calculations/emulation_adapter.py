...
from drivers.actions.trading_view_emulator import get_firefox_options, get_firefox_web_driver, \
    open_url_in_firefox_driver, emulate_loading_all_stocks_in_trading_view
from drivers.data.web_scraping_data import trading_view_url, index_to_analyze, index_name_prefix
